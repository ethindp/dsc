...
public:
  ...
  void inOrder(const std::shared_ptr<RbNode>,
               const std::function<void(const std::shared_ptr<RbNode>)>);
  void preOrder(const std::shared_ptr<RbNode>,
                const std::function<void(const std::shared_ptr<RbNode>)>);
  ...
  std::shared_ptr<RbNode> insertNode(const std::shared_ptr<RbNode>,
                                     const std::shared_ptr<RbNode>);
